...
if __name__ == "__main__":
    json_folder = "E:/TOFD-recognition/dataset-detection-class6"
    output_folder = "E:/TOFD-recognition/dataset-detection-class6/yolo_text_files"

    # Add your class mapping if label names differ between LabelMe and YOLO
    class_mapping = {
        'Geometry 1': '0',
        'ID Flaw': '1',
        'OD crack': '2',
    ...
    for filename in os.listdir(json_folder):
        if filename.endswith(".json"):
            ...
            labelme_seg_to_yolo(json_path, output_folder, class_mapping)
